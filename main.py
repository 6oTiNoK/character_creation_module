...
def special(char_name: str, char_class: str) -> str:
    """Докстринг к функции номер три и он чуть больше чем первый и второй."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Начало тренировки, выбор аттаки, защиты и специальных умений."""
    if char_class == 'warrior':
